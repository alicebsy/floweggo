...
|   이름    | 역할 | 담당 기능                                                     |              GitHub              |
|:-------:| :---: |:----------------------------------------------------------|:--------------------------------:|
| **배서연** | FE | 기획, 디자인, UI 기본 틀 구현, version1 UI 구현, 메인 로직들 구현            | [@alicebsy](https://github.com/) |
| **박찬우** | FE | 기획, 디자인, version2 UI 구현, ml kit + gemini 2.5 flash api 활용 |  [@onff02](https://github.com/)  |---
